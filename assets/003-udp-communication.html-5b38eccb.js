import{_ as i}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as e,h as s}from"./app-3f27a5c5.js";const d={},l=s(`<div class="hint-container tip"><p class="hint-container-title">简介</p><p>asio实现UDP通信</p></div><h2 id="asio库" tabindex="-1"><a class="header-anchor" href="#asio库" aria-hidden="true">#</a> Asio库</h2><p>Asio是一个跨平台的C++网络库，它是Boost库的一部分，它是异步输入输出的核心。Asio提供了一组异步的I/O操作，包括TCP和UDP的socket、定时器、串口等。Asio的核心是一个事件循环，它使用epoll、kqueue、IOCP等系统调用来实现异步I/O操作。Asio的事件循环是单线程的，但是它提供了一些接口来实现多线程的异步操作。</p><h2 id="udp客户端类" tabindex="-1"><a class="header-anchor" href="#udp客户端类" aria-hidden="true">#</a> UDP客户端类</h2><div class="language-C++ line-numbers-mode" data-ext="C++"><pre class="language-C++"><code>class UDPClient
{
public:
